...
<head>
    ...
    <!-- Add site Favicon -->
    <link rel="icon" href="/client/images/favicon/favicon.png" sizes="32x32" />
    <link rel="icon" href="/client/images/favicon/favicon.png" sizes="192x192" />
    <link rel="apple-touch-icon" href="/client/images/favicon/favicon.png" />
    <meta name="msapplication-TileImage" content="/client/images/favicon/favicon.png" />
    <!-- Structured Data  -->
    ...
    <link rel="stylesheet" href="/client/css/vendor/simple-line-icons.css" />
    <link rel="stylesheet" href="/client/css/vendor/ionicons.min.css" />

    <!-- plugins css (All Plugins Files) -->
    <link rel="stylesheet" href="/client/css/plugins/animate.css" />
    <link rel="stylesheet" href="/client/css/plugins/swiper-bundle.min.css" />
    <link rel="stylesheet" href="/client/css/plugins/jquery-ui.min.css" />
    <link rel="stylesheet" href="/client/css/plugins/jquery.lineProgressbar.css">
    <link rel="stylesheet" href="/client/css/plugins/nice-select.css" />
    <link rel="stylesheet" href="/client/css/plugins/venobox.css" />

    <!-- Use the minified version files listed below for better performance and remove the files listed above -->
    <!-- <link rel="stylesheet" href="/client/css/vendor/vendor.min.css" />
    <link rel="stylesheet" href="/client/css/plugins/plugins.min.css" />
    <link rel="stylesheet" href="/client/css/style.min.css"> -->

    <!-- Main Style -->
    <link rel="stylesheet" href="/client/css/style.css" />
    <link rel="stylesheet" href="/client/css/fontiran.css">
...
<body>
                ...
                <div class="row row-cols-lg-2 align-items-center">
                    ...
                    <div class="col text-center text-lg-left">
                        <div class="header-top-massege">
                            <p>به پروژه ی سایت فروشگاهی خوش آمدید </p>
                        </div>
                    </div>
                ...
                <div class="row align-self-center">
                    ...
                    <div class="col-auto align-self-center">
                        <div class="header-logo">
                            <a href="index.html"><img src="/client/images/logo/logo.png" alt="Site Logo" /></a>
                        </div>
                    </div>
                    <!-- Header Logo End -->
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    <li>
                        <a href="single-product.html" class="image"><img src="/client/images/product-image/1.jpg" alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="/client/images/product-image/2.jpg" alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="/client/images/product-image/3.jpg" alt="Cart product Image"></a>
                        <div class="content">
    ...
    @include('client.layouts.mobilemenu')
            <!-- OffCanvas Menu End -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-5 col-md-5 col-sm-5">
                                <div class="hero-slide-image">
                                    <img src="/client/images/slider-image/slider-1.png" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="hero-slide-item slider-height swiper-slide d-flex">
                    <div class="container align-self-center">
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-5 col-md-5 col-sm-5">
                                <div class="hero-slide-image">
                                    <img src="/client/images/slider-image/slider-2.png" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="category-slider swiper-container" data-aos="fade-up">
                <div class="category-wrapper swiper-wrapper">
                    ...
                    <div class=" swiper-slide">
                        <a href="shop-left-sidebar.html" class="category-inner ">
                            <div class="category-single-item">
                                <img src="/client/images/icons/1.png" alt="">
                    ...
                    <div class=" swiper-slide">
                        <a href="shop-left-sidebar.html" class="category-inner ">
                            <div class="category-single-item">
                                <img src="/client/images/icons/2.png" alt="">
                    ...
                    <div class=" swiper-slide">
                        <a href="shop-left-sidebar.html" class="category-inner ">
                            <div class="category-single-item">
                                <img src="/client/images/icons/3.png" alt="">
                    ...
                    <div class=" swiper-slide">
                        <a href="shop-left-sidebar.html" class="category-inner ">
                            <div class="category-single-item">
                                <img src="/client/images/icons/4.png" alt="">
                    ...
                    <div class="swiper-slide">
                        <a href="shop-left-sidebar.html" class="category-inner ">
                            <div class="category-single-item">
                                <img src="/client/images/icons/5.png" alt="">
            ...
            <div class="row">
                <div class="col-md-12 text-center" data-aos="fade-up">
                    <div class="section-title mb-0">
                        ...
                        <p class="sub-title mb-6">این یک متن تست برای صفحه ی اول فونت ها می باشد</p>
                    </div>
                </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                <img src="/client/images/product-image/1.jpg" alt="Product" />
                                                <img class="hover-image" src="/client/images/product-image/2.jpg" alt="Product" />
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6" data-aos="fade-up" data-aos-delay="400">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                <img src="/client/images/product-image/3.jpg" alt="Product" />
                                                <img class="hover-image" src="/client/images/product-image/4.jpg" alt="Product" />
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6" data-aos="fade-up" data-aos-delay="600">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                <img src="/client/images/product-image/5.jpg" alt="Product" />
                                                <img class="hover-image" src="/client/images/product-image/6.jpg" alt="Product" />
                                            </a>
                                            <span class="badges">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 mb-6" data-aos="fade-up" data-aos-delay="800">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="shop-left-sidebar.html" class="image">
                                                <img src="/client/images/product-image/7.jpg" alt="Product" />
                                                <img class="hover-image" src="/client/images/product-image/8.jpg" alt="Product" />
                                            </a>
                                            <span class="badges">
                                                <span class="new">New</span>
                                            </span>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-12 mb-md-30px mb-lm-30px" data-aos="fade-up" data-aos-delay="200">
                    <a href="shop-left-sidebar.html" class="banner">
                        <img src="/client/images/banner/1.jpg" alt="" />
                ...
                <div class="col-lg-6 col-12" data-aos="fade-up" data-aos-delay="400">
                    <a href="shop-left-sidebar.html" class="banner">
                        <img src="/client/images/banner/2.jpg" alt="" />
                ...
                <div class="swiper-wrapper">
                    <div class="single-blog swiper-slide">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="/client/images/blog-image/1.jpg" class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                    ...
                    <div class="single-blog swiper-slide">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="/client/images/blog-image/2.jpg" class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
                                <a class="blog-date" href="#">14 November</a>
                    ...
                    <div class="single-blog swiper-slide">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="/client/images/blog-image/3.jpg" class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
                                <a class="blog-date" href="#">14 November</a>
                    ...
                    <div class="single-blog swiper-slide">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="/client/images/blog-image/4.jpg" class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
                                <a class="blog-date" href="#">14 November</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-md-30px mb-lm-30px" data-aos="fade-up" data-aos-delay="200">
                    <div class="insta-wrapper">
                        <a href="https://www.instagram.com/" target="_blank"><img class="w-100" src="/client/images/instragram-image/1.png" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-md-30px mb-lm-30px" data-aos="fade-up" data-aos-delay="400">
                    <div class="insta-wrapper">
                        <a href="https://www.instagram.com/" target="_blank"><img class="w-100" src="/client/images/instragram-image/2.png" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 mb-xs-30px" data-aos="fade-up" data-aos-delay="600">
                    <div class="insta-wrapper">
                        <a href="https://www.instagram.com/" target="_blank"><img class="w-100" src="/client/images/instragram-image/3.png" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 " data-aos="fade-up" data-aos-delay="800">
                    <div class="insta-wrapper">
                        <a href="https://www.instagram.com/" target="_blank"><img class="w-100" src="/client/images/instragram-image/4.png" alt="">
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12 mb-lm-30px mb-sm-30px">
                            ...
                            <div class="swiper-container gallery-top mb-4">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="/client/images/product-image/1.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="/client/images/product-image/2.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="/client/images/product-image/3.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="/client/images/product-image/4.jpg" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img class="img-responsive m-auto" src="/client/images/product-image/5.jpg" alt="">
                                    </div>
                                </div>
                            </div>
    ...
    <!-- Vendor JS -->
    <!-- <script src="/client/js/vendor/jquery-3.5.1.min.js"></script>
    <script src="/client/js/vendor/popper.min.js"></script>
    <script src="/client/js/vendor/bootstrap.min.js"></script>
    <script src="/client/js/vendor/jquery-migrate-3.3.0.min.js"></script>
    <script src="/client/js/vendor/modernizr-3.11.2.min.js"></script> -->

    <!--Plugins JS-->
    <!-- <script src="/client/js/plugins/swiper-bundle.min.js"></script>
    <script src="/client/js/plugins/jquery-ui.min.js"></script>
    <script src="/client/js/plugins/jquery.nice-select.min.js"></script>
    <script src="/client/js/plugins/countdown.js"></script>
    <script src="/client/js/plugins/scrollup.js"></script>
    <script src="/client/js/plugins/jquery.waypoints.js"></script>
    <script src="/client/js/plugins/jquery.lineProgressbar.js"></script>
    <script src="/client/js/plugins/jquery.zoom.min.js"></script>
    <script src="/client/js/plugins/venobox.min.js"></script>
    <script src="/client/js/plugins/ajax-mail.js"></script> -->

    <!-- Use the minified version files listed below for better performance and remove the files listed above -->
    <script src="/client/js/vendor/vendor.min.js"></script>
    <script src="/client/js/plugins/plugins.min.js"></script>
