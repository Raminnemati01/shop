...
<head>
   ...
   <link rel="stylesheet" href="/admin/fonts/icofont/icofont.min.css">


   <!-- Web Fonts -->

   <link rel="stylesheet" href="/admin/css/fontiran.css">


   <!-- ======= BEGIN GLOBAL MANDATORY STYLES ======= -->
   <link rel="stylesheet" href="/admin/bootstrap/css/bootstrap.min.css">
   <link rel="stylesheet" href="/admin/fonts/icofont/icofont.min.css">
   <link rel="stylesheet" href="/admin/plugins/perfect-scrollbar/perfect-scrollbar.min.css">
   <!-- ======= END BEGIN GLOBAL MANDATORY STYLES ======= -->

   <!-- ======= BEGIN PAGE LEVEL PLUGINS STYLES ======= -->
   <link rel="stylesheet" href="/admin/plugins/apex/apexcharts.css">
...
<body>
   ...
   <div class="wrapper">
      ...
      <header class="header white-bg fixed-top d-flex align-content-center flex-wrap">
         <!-- Logo -->
         <div class="logo">
            <a href="index.html" class="default-logo"><img src="/admin/img/logo.png" alt=""></a>
            <a href="index.html" class="mobile-logo"><img src="/admin/img/mobile-logo.png" alt=""></a>
         </div>
         <!-- End Logo -->
                           ...
                           <a href="#" class="d-flex align-items-center" data-toggle="dropdown">
                              ...
                              <div class="user-profile d-xl-flex align-items-center d-none">
                                 ...
                                 <div class="user-avatar">
                                    <img src="/admin/img/avatar/user.png" alt="">
                                 </div>
                                 <!-- End User Avatar -->
                        ...
                        <ul class="nav">
                           <li class="ml-0">
                              ...
                              <div class="main-header-language">
                                 <a href="#" data-toggle="dropdown">
                                    <img src="/admin/img/svg/globe-icon.svg" alt="">
                                 </a>
                                 <div class="dropdown-menu style--three">
                                    <a href="#">
                                       <span><img src="/admin/img/usa.png" alt=""></span>
                                       USA
                                    </a>
                                    <a href="#">
                                       <span><img src="/admin/img/china.png" alt=""></span>
                                       China
                                    </a>
                                    <a href="#">
                                       <span><img src="/admin/img/russia.png" alt=""></span>
                                       Russia
                                    </a>
                                    <a href="#">
                                       <span><img src="/admin/img/spain.png" alt=""></span>
                                       Spain
                                    </a>
                                    <a href="#">
                                       <span><img src="/admin/img/brazil.png" alt=""></span>
                                       Brazil
                                    </a>
                                    <a href="#">
                                       <span><img src="/admin/img/france.png" alt=""></span>
                                       France
                                    </a>
                                    <a href="#">
                                       <span><img src="/admin/img/algeria.png" alt=""></span>
                                       Algeria
                                    </a>
                                 </div>
                              </div>
                           ...
                           <li class="ml-0 d-none d-lg-flex">
                              ...
                              <div class="main-header-print">
                                 <a href="#">
                                    <img src="/admin/img/svg/print-icon.svg" alt="">
                                 </a>
                              </div>
                              ...
                              <div class="main-header-search">
                                 <form action="#" class="search-form">
                                    <div class="theme-input-group header-search">
                                       ...
                                       <button type="submit"><img src="/admin/img/svg/search-icon.svg" alt=""
                                             class="svg"></button>
                                    </div>
                                 </form>
                              </div>
                           ...
                           <li>
                              ...
                              <div class="main-header-message">
                                 <a href="#" class="header-icon" data-toggle="dropdown">
                                    <img src="/admin/img/svg/message-icon.svg" alt="" class="svg">
                                 </a>
                                 <div class="dropdown-menu">
                                    <!-- Dropdown Header -->
                                    ...
                                    <div class="dropdown-body">
                                       ...
                                       <a href="#" class="item-single d-flex media align-items-center">
                                          <div class="figure">
                                             <img src="/admin/img/avatar/m1.png" alt="">
                                       ...
                                       <a href="#" class="item-single d-flex media align-items-center">
                                          <div class="figure">
                                             <img src="/admin/img/avatar/m2.png" alt="">
                                             <span class="avatar-status bg-teal"></span>
                                          </div>
                                          <div class="content media-body">
                                             <div class="d-flex align-items-center mb-2">
                                       ...
                                       <a href="#" class="item-single d-flex media align-items-center">
                                          <div class="figure">
                                             <img src="/admin/img/avatar/m3.png" alt="">
                                             <span class="avatar-status bg-teal"></span>
                                          </div>
                                          <div class="content media-body">
                                             <div class="d-flex align-items-center mb-2">
                                       ...
                                       <a href="#" class="item-single d-flex media align-items-center">
                                          <div class="figure">
                                             <img src="/admin/img/avatar/m4.png" alt="">
                                             <span class="avatar-status bg-teal"></span>
                                          </div>
                                          <div class="content media-body">
                                             <div class="d-flex align-items-center mb-2">
                           ...
                           <li>
                              ...
                              <div class="main-header-notification">
                                 <a href="#" class="header-icon notification-icon" data-toggle="dropdown">
                                    <span class="count" data-bg-img="/admin/img/count-bg.png">22</span>
                                    <img src="/admin/img/svg/notification-icon.svg" alt="" class="svg">
                                 </a>
                        ...
                        <div class="card-body">
                           <div class="d-flex align-items-center justify-content-between">
                              ...
                              <div class="congratulation-img">
                                 <img src="/admin/img/media/congratulation-img.png" alt="">
                              </div>
                           </div>
                        </div>
                     </div>
                           ...
                           <div class="card mb-30 progress_1">
                              <div class="card-body">
                                 ...
                                 <div class="d-flex flex-wrap mb-2 progress-info">
                                    <div>Users</div>
                                    <div><img src="/admin/img/svg/caret-up.svg" alt="" class="svg"> 2.6k</div>
                                    <div><img src="/admin/img/svg/caret-down.svg" alt="" class="svg">568</div>
                                 </div>


                                 <div class="d-flex flex-wrap progress-info">
                                    <div>Disabled</div>
                                    <div><img src="/admin/img/svg/caret-up.svg" alt="" class="svg">1.26k</div>
                                    <div><img src="/admin/img/svg/caret-down.svg" alt="" class="svg">25</div>
                                 </div>
                              </div>
                           </div>
                           <!-- End Card -->
                        ...
                        <div class="col-md-4 col-sm-6">
                           ...
                           <div class="card mb-30 progress_2">
                              <div class="card-body">
                                 ...
                                 <div class="d-flex flex-wrap mb-2 progress-info">
                                    <div>Net Profit</div>
                                    <div><img src="/admin/img/svg/caret-up.svg" alt="" class="svg"> 268k</div>
                                    <div><img src="/admin/img/svg/caret-down.svg" alt="" class="svg">89k</div>
                                 </div>
                                 ...
                                 <div class="d-flex flex-wrap progress-info">
                                    <div>Expenses</div>
                                    <div><img src="/admin/img/svg/caret-up.svg" alt="" class="svg">1.26k</div>
                                    <div><img src="/admin/img/svg/caret-down.svg" alt="" class="svg">1.5k</div>
                                 </div>
                              </div>
                           </div>
                           <!-- End Card -->
                        ...
                        <div class="col-md-4 col-sm-6">
                           ...
                           <div class="card mb-30 progress_3 mr-0">
                              <div class="card-body">
                                 ...
                                 <div class="d-flex flex-wrap mb-2 progress-info">
                                    <div>Employee</div>
                                    <div><img src="/admin/img/svg/caret-up.svg" alt="" class="svg">15</div>
                                    <div><img src="/admin/img/svg/caret-down.svg" alt="" class="svg">3</div>
                                 </div>
                                 ...
                                 <div class="d-flex flex-wrap progress-info">
                                    <div>Production</div>
                                    <div><img src="/admin/img/svg/caret-up.svg" alt="" class="svg">1.26k</div>
                                    <div><img src="/admin/img/svg/caret-down.svg" alt="" class="svg">1.2k</div>
                                 </div>
                              </div>
                           </div>
                           <!-- End Card -->
                              ...
                              <div class="card-body p-0">
                                    ...
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                       ...
                                       <div class="d-flex align-items-center">
                                          <a href="pages/apps/todolist/add-new.html" class="btn-circle">
                                             <img src="/admin/img/svg/plus_white.svg" alt="" class="svg">
                                          </a>
                                 ...
                                 <div class="single-row border-bottom pt-3 pb-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                       ...
                                       <div class="d-flex">
                                          <!-- Assign To -->
                                          <div class="assign_to">
                                             <img src="/admin/img/svg/Info.svg" alt="" class="svg mr-2 mb-1">
                                             <div class="assign-content">
                                                <div class="font-12 text-warning">Back-End</div>
                                                <img src="/admin/img/avatar/info-avatar.png" alt="" class="assign-avatar">
                                             </div>
                                          </div>
                                          <!-- End Assign To -->

                                          <!-- Drag Icon -->
                                          <img src="/admin/img/svg/dragicon.svg" alt="" class="svg">
                                          <!-- End Drag Icon -->
                                 ...
                                 <div class="single-row border-bottom pt-3 pb-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                       ...
                                       <div class="d-flex">
                                          <!-- Drag Icon -->
                                          <img src="/admin/img/svg/dragicon.svg" alt="" class="svg mr-2">
                                          <!-- End Drag Icon -->
                                          <!-- Assign To -->
                                          <div class="assign_to">
                                             <img src="/admin/img/svg/Info.svg" alt="" class="svg mb-1">
                                          </div>
                                          <!-- End Assign To -->
   ...
   <script src="/admin/plugins/apex/custom-apexcharts.js"></script>
